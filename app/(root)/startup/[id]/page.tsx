    ...
    <>
     ...
     <section className='section_container '>
        ...
        <div className='space-y-5 mt-10 max-w-4xl mx-auto'>
            ...
            {
                parsedContent ? <article className='prose max-w-4xl font-work-sans break-all' dangerouslySetInnerHTML={{__html:parsedContent}}/>:<p className='no-result'>No Details</p>
            }
        </div>
